    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (p == null) {
                ...
                request.getRequestDispatcher("/shopowner/products_shop_owner.jsp").forward(request, response);
                return;
            }
            ...
            request.getRequestDispatcher("/shopowner/edit_product.jsp").forward(request, response);
